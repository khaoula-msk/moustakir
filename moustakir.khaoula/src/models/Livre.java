...
public class Livre {
	...
	public Livre(int id, int isbn, String titre, String description, int annee_edition,
	...
	public Livre(int isbn, String titre, String description, int annee_edition, Categorie categorie,Personne auteur) {
		super();
		this.isbn = isbn;
		this.titre = titre;
		this.description = description;
	...
	public String toString() {
		return "Livre [id=" + id + ", isbn=" + isbn + ", titre=" + titre + ", description="
