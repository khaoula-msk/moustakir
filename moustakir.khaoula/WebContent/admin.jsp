              ...
              <div class="col-md-10 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <p class="card-description"> Veuillez saisir les donnees de votre Etudiant: </p>
                    <form class="forms-sample" action="admin" method="post">
                      ...
                      <div class="form-group">
                        ...
                        <input type="password" name="mdp" class="form-control" id="exampleInputPassword4" placeholder="***********">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputEmail3">CNE</label>
                        <input type="text" name="cne" class="form-control" id="exampleInputEmail3" placeholder="R123456789">
                      </div>
