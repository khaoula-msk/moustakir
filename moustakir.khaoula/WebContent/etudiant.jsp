...
<html lang="en">
  <head>
    ...
    <title> Espace Etudiant |BOOK-READER </title>
    <!-- plugins:css -->
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="http://localhost:8080/moustakir.khaoula/etudiant">
                <i class="menu-icon typcn typcn-shopping-bag"></i>
                <span class="menu-title">Reserver Livre</span>
              </a>
            </li>

            <li class="nav-item">
              <a class="nav-link" href="http://localhost:8080/moustakir.khaoula/afficherlivres.jsp">
                <i class="menu-icon typcn typcn-bell"></i>
                <span class="menu-title">Afficher liste des livres</span>
              </a>
            </li>
              ...
              <div class="col-md-10 d-flex align-items-stretch grid-margin">
                <div class="row flex-grow">
                  <div class="col-12">
                    <div class="card">
                      <div class="card-body">
                    <h4 class="card-title">RESERVER VOTRE LIVRE</h4>
                    <p class="card-description"> Veuillez saisir les donnees du livre: </p>
                    <form class="forms-sample" action="etudiant" method="post">
                      <div class="form-group">
                        <label for="exampleInputName1">Livre</label>
                             <div class="col-sm-10">
  	<%ArrayList<Livre> livres = serviceLivre.listeLivres();%>
                                                                    <select name="select" class="form-control">
                                                                    	<% for(Livre l:livres){ %>
                                                                        <option value="opt1"><%=l.getTitre() %></option>
                                                                        <%} %>
</select>
</div>                   
   </div>
                       <div class="form-group">
                        <label for="exampleInputName1">Id etudiant</label>
                     <div class="col-sm-10">
<%ArrayList<Personne> etudiants = servicePersonne.listeEtudiants();%>
                                                                
<select name="select" class="form-control">
	<% for(Personne e:etudiants){ %>
<option value="opt1"><%=e.getNom() %></option>
<%} %>   
</select>
</div>     
</div>
